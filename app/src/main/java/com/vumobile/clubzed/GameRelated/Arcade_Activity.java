 ...
 */
public class Arcade_Activity extends Activity {
    ListView actionListView;
    NetworkImageView actionPageHeader;
    String URL="http://wap.shabox.mobi/GCMPanel/ClubzAPI.aspx?cat=Arcade";
    ...
    public  int feed=0;
    private int preLast;
    GameItemListActivity gameItemListActivity;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        gameItemListActivity=new GameItemListActivity();
        adapter = new GameListCustomAdapter(pictureList,Arcade_Activity.this);
            ...
            public void onScroll(AbsListView view, int firstVisibleItem,
                ...
                if (lastItem == totalItemCount) {
                    if (preLast != lastItem) { //to avoid multiple calls for last item
                        ...
                        pDialog = new ProgressDialog(Arcade_Activity.this);
