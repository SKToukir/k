...
public class GameSportsAdapter extends RecyclerView.Adapter<GameSportsAdapter.MyViewHolder> {

    ImageLoader imageLoader;
    private Context mContext;
    private List<GameSportsClass> gameSportsClassList;

    public GameSportsAdapter(Context context, List<GameSportsClass> gameSportsClasses){
        this.mContext = context;
        this.gameSportsClassList = gameSportsClasses;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        GameSportsClass primaryClass = gameSportsClassList.get(position);
    ...
    public int getItemCount() {
        return gameSportsClassList.size();
    }
