...
public class Pic_Hoolywood_Celebrity extends ActionBarActivity {
    ...
    private static String FEED_URL="http://wap.shabox.mobi/GCMPanel/ClubzAPI.aspx?cat=holy";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Subscriptio_Class.applicationContext=Pic_Hoolywood_Celebrity.this;
    ...
    public class AsyncHttpTask extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (result == 1) {
                ...
                Toast.makeText(Pic_Hoolywood_Celebrity.this, "Failed to fetch data!", Toast.LENGTH_SHORT).show();
            }
