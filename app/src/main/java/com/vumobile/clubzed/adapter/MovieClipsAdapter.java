...
public class MovieClipsAdapter extends RecyclerView.Adapter<MovieClipsAdapter.MyViewHolder> {

    ImageLoader imageLoader;
    private Context mContext;
    private List<MovieClipsClass> movieClipsClassList;

    public MovieClipsAdapter(Context context, List<MovieClipsClass> movieClipsClassLists){
        this.mContext = context;
        this.movieClipsClassList = movieClipsClassLists;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        MovieClipsClass primaryClass = movieClipsClassList.get(position);
    ...
    public int getItemCount() {
        return movieClipsClassList.size();
    }
