 ...
 */
public class GameOfTheWeek extends Activity {
    ListView actionListView;
    NetworkImageView actionPageHeader;
    String URL="http://wap.shabox.mobi/GCMPanel/ClubzAPI.aspx?cat=gameofweek";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game_of_theweek_);
        ...
        adapter = new GameListCustomAdapter(pictureList,GameOfTheWeek.this);
            ...
            public void onScroll(AbsListView view, int firstVisibleItem,
                ...
                if (lastItem == totalItemCount) {
                    if (preLast != lastItem) { //to avoid multiple calls for last item
                        ...
                        pDialog = new ProgressDialog(GameOfTheWeek.this);
