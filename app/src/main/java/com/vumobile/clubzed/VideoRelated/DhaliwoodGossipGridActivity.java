...
public class DhaliwoodGossipGridActivity extends ActionBarActivity {
    ...
    Button btnBack;
    //Web api url
    public static final String DATA_URL = Config.URL_DHALLYWOOD_GOSSIP;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dhaliwood_gossip_grid);

        toolbar = (Toolbar) findViewById(R.id.tool_bar_dhaliwood);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("");
        btnBack = (Button) toolbar.findViewById(R.id.btn_back);

        mPullRefreshGridView = (PullToRefreshGridView) findViewById(R.id.gridViewdhaliwood);
...
//            }
        ...
        Subscriptio_Class.applicationContext= DhaliwoodGossipGridActivity.this;
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DhaliwoodGossipGridActivity.this.finish();
    ...
    private void getData(final int num){
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(DhaliwoodGossipGridActivity.this);
    ...
    private void showGrid(JSONArray jsonArray,int y){
        ...
        for (int i = 0; i < 10 + y; i++) {
            DhaliwoodGossipClass dhaliwoodGossipClass = new DhaliwoodGossipClass();
...
//                fullVideoClass.setContent_image(Config.URL_SOURCE+imgUrl);
                ...
                imgUrl = obj.getString(Config.CONTENT_IMAGE_DHALLYWOOD_GOSSIP).replace(" ", "%20");
                dhaliwoodGossipClass.setContent_image(Config.URL_SOURCE + imgUrl);
                images.add(Config.URL_SOURCE + imgUrl);
                names.add(obj.getString(Config.CONTENT_NAME_DHALLYWOOD_GOSSIP));
    ...
    public void btnNextdhaliwoodGrid(View view) {
        images = new ArrayList<>();
        names = new ArrayList<>();
        likes = new ArrayList<>();
        views = new ArrayList<>();
