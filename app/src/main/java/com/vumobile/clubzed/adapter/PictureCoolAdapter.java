...
public class PictureCoolAdapter extends RecyclerView.Adapter<PictureCoolAdapter.MyViewHolder> {

    ImageLoader imageLoader;
    private Context mContext;
    private List<PictureCoolClass> pictureCoolClassList;

    public PictureCoolAdapter(Context context, List<PictureCoolClass> picList){
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        PictureCoolClass primaryClass = pictureCoolClassList.get(position);
