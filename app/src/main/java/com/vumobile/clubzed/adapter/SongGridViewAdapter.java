...
public class SongGridViewAdapter extends BaseAdapter {
    ...
    public SongGridViewAdapter (Context context, ArrayList<String> images, ArrayList<String> names, ArrayList<String> likes,ArrayList<String> views){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            ...
            grid = inflater.inflate(R.layout.grid_song_row, null);
        }else{
            grid = convertView;
        }
