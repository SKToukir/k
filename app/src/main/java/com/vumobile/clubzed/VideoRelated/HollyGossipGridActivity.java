...
public class HollyGossipGridActivity extends ActionBarActivity {
    ...
    Button btnBack;
    //Web api url
    public static final String DATA_URL = Config.URL_HOLLYWOOD_GOSSIP;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_holly_gossip_grid);

        toolbar = (Toolbar) findViewById(R.id.tool_bar_holygossip);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("");
        btnBack = (Button) toolbar.findViewById(R.id.btn_back);

        mPullRefreshGridView = (PullToRefreshGridView) findViewById(R.id.gridViewholygossip);
...
//            }
        ...
        Subscriptio_Class.applicationContext= HollyGossipGridActivity.this;
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                HollyGossipGridActivity.this.finish();
    ...
    private void getData(final int num){
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(HollyGossipGridActivity.this);
    ...
    private void showGrid(JSONArray jsonArray,int y){
        ...
        for (int i = 0; i < 10 + y; i++) {
            HollywoodGossipClass hollywoodGossipClass = new HollywoodGossipClass();
...
//                fullVideoClass.setContent_image(Config.URL_SOURCE+imgUrl);
                ...
                imgUrl = obj.getString(Config.CONTENT_IMAGE_HOLLYWOOD_GOSSIP).replace(" ", "%20");
                hollywoodGossipClass.setContent_image(Config.URL_SOURCE + imgUrl);
                hollywoodGossipClass.setTotal_likes(obj.getString(Config.TOTAL_LIKE));
                hollywoodGossipClass.setTotal_views(obj.getString(Config.VIEWS));
                ...
                names.add(obj.getString(Config.CONTENT_NAME_HOLLYWOOD_GOSSIP));
    ...
    public void btnNextholygossipGrid(View view) {
        images = new ArrayList<>();
        names = new ArrayList<>();
        likes = new ArrayList<>();
        views = new ArrayList<>();
