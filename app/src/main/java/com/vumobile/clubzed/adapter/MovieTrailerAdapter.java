...
public class MovieTrailerAdapter extends RecyclerView.Adapter<MovieTrailerAdapter.MyViewHolder> {
    ...
    private List<MovieTrailerClass> movieTrailerClassList;

    public MovieTrailerAdapter(Context context, List<MovieTrailerClass> movieTrailerClassLists){
        this.mContext = context;
        this.movieTrailerClassList = movieTrailerClassLists;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        MovieTrailerClass primaryClass = movieTrailerClassList.get(position);
    ...
    public int getItemCount() {
        return movieTrailerClassList.size();
    }
