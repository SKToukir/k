...
public class CelebratyNewsGridActivity extends ActionBarActivity {
    ...
    Button btnBack;
    //Web api url
    public static final String DATA_URL = Config.URL_CELEBRATY_NEWS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_celebraty_news_grid);

        toolbar = (Toolbar) findViewById(R.id.tool_bar_celenews);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("");
        btnBack = (Button) toolbar.findViewById(R.id.btn_back);

        mPullRefreshGridView = (PullToRefreshGridView) findViewById(R.id.gridViewcelenews);
...
//            }
        ...
        Subscriptio_Class.applicationContext= CelebratyNewsGridActivity.this;
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CelebratyNewsGridActivity.this.finish();
    ...
    private void getData(final int num){
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(CelebratyNewsGridActivity.this);
    ...
    private void showGrid(JSONArray jsonArray,int y){
        ...
        for (int i = 0; i < 10 + y; i++) {
            CelebratyNewsClass celebratyNewsClass = new CelebratyNewsClass();
...
//                fullVideoClass.setContent_image(Config.URL_SOURCE+imgUrl);
                ...
                imgUrl = obj.getString(Config.CONTENT_IMAGE_CELEBRATY_NEWS).replace(" ", "%20");
                celebratyNewsClass.setContent_image(Config.URL_SOURCE + imgUrl);
                celebratyNewsClass.setTotal_like(obj.getString(Config.TOTAL_LIKE));
                celebratyNewsClass.setTotal_views(obj.getString(Config.VIEWS));
                ...
                names.add(obj.getString(Config.CONTENT_NAME_CELEBRATY_NEWS));
    ...
    public void btnNextcelenewsGrid(View view) {
        images = new ArrayList<>();
        names = new ArrayList<>();
        likes = new ArrayList<>();
        views = new ArrayList<>();
