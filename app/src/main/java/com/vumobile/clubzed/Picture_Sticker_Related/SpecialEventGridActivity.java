...
public class SpecialEventGridActivity extends ActionBarActivity {
    private PullToRefreshGridView mPullRefreshGridView;
    Subscriptio_Class subscriptio_class;
    Toolbar toolbar;
    Button btnBack;
    //Web api url
    public static final String DATA_URL = Config.URL_PICTURE_SPECIAL_EVENT;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_special_event_grid);

        toolbar = (Toolbar) findViewById(R.id.tool_bar_grid_special_event);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("");
        btnBack = (Button) toolbar.findViewById(R.id.btn_back);

        mPullRefreshGridView = (PullToRefreshGridView) findViewById(R.id.gridViewgrid_special_event);
        ...
        mPullRefreshGridView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener<GridView>() {
            ...
            public void onRefresh(PullToRefreshBase<GridView> refreshView) {
                ...
                specialEventList = new ArrayList<PictureSpecialEventClass>();
                n+=10;
                getData(n);
            }
...
//            }
        ...
        Subscriptio_Class.applicationContext=SpecialEventGridActivity.this;
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SpecialEventGridActivity.this.finish();
    ...
    private void getData(final int num){
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        try {
                            ...
                            for (int i = 0; i<=9+num; i++){
                                ...
                                images.add(pictureSpecialEventClass.getImage_url());
                                names.add(pictureSpecialEventClass.getContent_title());
                            ...
                            GameGridAdapter gameGridAdapter = new GameGridAdapter(SpecialEventGridActivity.this,images,names,likes,downloads);
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(SpecialEventGridActivity.this);
...
//        gameGridAdapter.notifyDataSetChanged();
//    }
    public void btnLoadMoregrid_special_event(View view) {
        images = new ArrayList<>();
        names = new ArrayList<>();
        likes = new ArrayList<>();
