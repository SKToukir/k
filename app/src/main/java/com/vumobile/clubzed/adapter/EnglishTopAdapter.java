...
public class EnglishTopAdapter extends RecyclerView.Adapter<EnglishTopAdapter.MyViewHolder> {

    ImageLoader imageLoader;
    private Context mContext;
    private List<EnglishTopClass> englishTopClassList;

    public EnglishTopAdapter(Context context, List<EnglishTopClass> englishTopClassLists){
        this.mContext = context;
        this.englishTopClassList = englishTopClassLists;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        EnglishTopClass primaryClass = englishTopClassList.get(position);
    ...
    public int getItemCount() {
        return englishTopClassList.size();
    }
