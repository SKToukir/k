...
public class Sticker_Eid extends ActionBarActivity {
    ...
    private static String FEED_URL="http://wap.shabox.mobi/GCMPanel/ClubzAPI.aspx?cat=stk&subcat=EID";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Subscriptio_Class.applicationContext=Sticker_Eid.this;
    ...
    public class AsyncHttpTask extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (result == 1) {
                ...
                Toast.makeText(Sticker_Eid.this, "Failed to fetch data!", Toast.LENGTH_SHORT).show();
            }
