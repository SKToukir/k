...
public class Video_Movie_Trailer extends Activity {
    ListView actionListView;
    NetworkImageView actionPageHeader;
    public  String URL = "http://wap.shabox.mobi/GCMPanel/ClubzAPI.aspx?cat=video_Cat&subcat=MovieTrailer";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video__movie_trailer);
        ...
        Subscriptio_Class.applicationContext=Video_Movie_Trailer.this;
        subscriptio_class=new Subscriptio_Class();
        Subscriptio_Class.type="video";
        adapter = new VideoListCustomAdapter(pictureList,Video_Movie_Trailer.this);
                ...
                if (lastItem == totalItemCount) {
                    if (preLast != lastItem) { //to avoid multiple calls for last item
                        ...
                        if (onscroll==true) {
                            ...
                            pDialog = new ProgressDialog(Video_Movie_Trailer.this);
