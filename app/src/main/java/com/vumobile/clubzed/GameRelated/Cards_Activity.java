 ...
 */
public class Cards_Activity extends Activity {
    ListView actionListView;
    NetworkImageView actionPageHeader;
    String URL="http://wap.shabox.mobi/GCMPanel/ClubzAPI.aspx?cat=Topgame";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cards_);
        ...
        adapter = new GameListCustomAdapter(pictureList,Cards_Activity.this);
            ...
            public void onScroll(AbsListView view, int firstVisibleItem,
                ...
                if (lastItem == totalItemCount) {
                    if (preLast != lastItem) { //to avoid multiple calls for last item
                        ...
                        pDialog = new ProgressDialog(Cards_Activity.this);
