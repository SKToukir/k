 ...
 */
public class Racing_Activity extends Activity {
    ListView actionListView;
    NetworkImageView actionPageHeader;
    String  URL="http://wap.shabox.mobi/GCMPanel/ClubzAPI.aspx?cat=Racing";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new GameListCustomAdapter(pictureList,Racing_Activity.this);
            ...
            public void onScroll(AbsListView view, int firstVisibleItem,
                ...
                if (lastItem == totalItemCount) {
                    if (preLast != lastItem) { //to avoid multiple calls for last item
                        ...
                        pDialog = new ProgressDialog(Racing_Activity.this);
