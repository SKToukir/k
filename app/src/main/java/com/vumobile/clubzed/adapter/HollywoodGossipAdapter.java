...
public class HollywoodGossipAdapter extends RecyclerView.Adapter<HollywoodGossipAdapter.MyViewHolder> {

    ImageLoader imageLoader;
    private Context mContext;
    private List<HollywoodGossipClass> hollywoodGossipClassList;

    public HollywoodGossipAdapter(Context context, List<HollywoodGossipClass> hollywoodGossipClassLists){
        this.mContext = context;
        this.hollywoodGossipClassList = hollywoodGossipClassLists;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        HollywoodGossipClass primaryClass = hollywoodGossipClassList.get(position);
        imageLoader = CustomVolleyRequest.getInstance(mContext).getImageLoader();

            holder.txtLikes.setText(primaryClass.getTotal_likes());
    ...
    public int getItemCount() {
        return hollywoodGossipClassList.size();
    }
