...
public class MusicAdapter extends RecyclerView.Adapter<MusicAdapter.MyViewHolder> {
    ...
    public MusicAdapter(Context context, List<MusicClass> musicClasses){
        this.mContext = context;
        this.musicClassList = musicClasses;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        MusicClass primaryClass = musicClassList.get(position);
        ...
        holder.videoTitle.setText(primaryClass.getCintent_title().replace("_"," "));

    }

    @Override
    public int getItemCount() {
        return musicClassList.size();
    }
