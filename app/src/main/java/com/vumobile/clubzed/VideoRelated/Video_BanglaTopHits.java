...
public class Video_BanglaTopHits extends Activity {
    ListView actionListView;
    NetworkImageView actionPageHeader;
    public  String URL = "http://wap.shabox.mobi/GCMPanel/ClubzAPI.aspx?cat=video_Cat&subcat=BanglaTOP";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Subscriptio_Class.applicationContext=Video_BanglaTopHits.this;
        subscriptio_class=new Subscriptio_Class();
        Subscriptio_Class.type="video";
        adapter = new VideoListCustomAdapter(pictureList,Video_BanglaTopHits.this);
            ...
            public void onScroll(AbsListView view, int firstVisibleItem,
                ...
                if (lastItem == totalItemCount) {
                    if (preLast != lastItem) { //to avoid multiple calls for last item
                        ...
                        pDialog = new ProgressDialog(Video_BanglaTopHits.this);
