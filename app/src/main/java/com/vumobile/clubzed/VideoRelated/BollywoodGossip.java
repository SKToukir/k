...
public class BollywoodGossip  extends Activity {
    ListView actionListView;
    NetworkImageView actionPageHeader;
    public  String URL = "http://wap.shabox.mobi/GCMPanel/ClubzAPI.aspx?cat=video_Cat&subcat=HollywoodGossip";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video__of_the_week);
        ...
        Subscriptio_Class.applicationContext=BollywoodGossip.this;
        subscriptio_class=new Subscriptio_Class();
        Subscriptio_Class.type="video";
        adapter = new VideoListCustomAdapter(pictureList,BollywoodGossip.this);
