...
public class StickerIslamicAdapter extends RecyclerView.Adapter<StickerIslamicAdapter.MyViewHolder> {

    ImageLoader imageLoader;
    private Context mContext;
    private List<StickerIslamicClass> stickerIslamicClassList;

    public StickerIslamicAdapter(Context context, List<StickerIslamicClass> List){
        this.mContext = context;
        this.stickerIslamicClassList = List;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        StickerIslamicClass primaryClass = stickerIslamicClassList.get(position);
    ...
    public int getItemCount() {
        return stickerIslamicClassList.size();
    }
