...
public class CelebratyNewsAdapter extends RecyclerView.Adapter<CelebratyNewsAdapter.MyViewHolder> {

    ImageLoader imageLoader;
    private Context mContext;
    private List<CelebratyNewsClass> celebratyNewsClassList;

    public CelebratyNewsAdapter(Context context, List<CelebratyNewsClass> celebratyNewsClassList1){
        this.mContext = context;
        this.celebratyNewsClassList = celebratyNewsClassList1;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        CelebratyNewsClass primaryClass = celebratyNewsClassList.get(position);
    ...
    public int getItemCount() {
        return celebratyNewsClassList.size();
    }
