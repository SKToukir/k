...
public class LifeStyleAdapter extends RecyclerView.Adapter<LifeStyleAdapter.MyViewHolder> {
    ...
    private List<LifeStyleClass> lifeStyleClassList;

    public LifeStyleAdapter(Context context, List<LifeStyleClass> Lists){
        this.mContext = context;
        this.lifeStyleClassList = Lists;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        LifeStyleClass primaryClass = lifeStyleClassList.get(position);
        imageLoader = CustomVolleyRequest.getInstance(mContext).getImageLoader();
        holder.txtLikes.setText(primaryClass.getTotal_like());
        holder.txtViews.setText(primaryClass.getTotal_view());
    ...
    public int getItemCount() {
        return lifeStyleClassList.size();
    }
