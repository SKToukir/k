...
public class StickerEidGridActivity extends ActionBarActivity {
    private PullToRefreshGridView mPullRefreshGridView;
    Subscriptio_Class subscriptio_class;
    Toolbar toolbar;
    Button btnBack;
    //Web api url
    public static final String DATA_URL = Config.URL_STICKER_EID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sticker_eid_grid);

        toolbar = (Toolbar) findViewById(R.id.tool_bar_grid_stickerEid);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("");
        btnBack = (Button) toolbar.findViewById(R.id.btn_back);

        mPullRefreshGridView = (PullToRefreshGridView) findViewById(R.id.gridViewgrid_stickerEid);
        ...
        mPullRefreshGridView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener<GridView>() {
            ...
            public void onRefresh(PullToRefreshBase<GridView> refreshView) {
                ...
                stickerEidClassList = new ArrayList<StickerEidClass>();
                n+=10;
                getData(n);
            }
...
//            }
        ...
        Subscriptio_Class.applicationContext=StickerEidGridActivity.this;
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                StickerEidGridActivity.this.finish();
    ...
    private void getData(final int num){
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        try {
                            ...
                            for (int i = 0; i<=9+num; i++){
                                ...
                                images.add(eidClass.getImageUrl());
                                names.add(eidClass.getContent_title());
                            ...
                            GameGridAdapter gameGridAdapter = new GameGridAdapter(StickerEidGridActivity.this,images,names,likes,downloads);
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(StickerEidGridActivity.this);
...
//        gameGridAdapter.notifyDataSetChanged();
//    }
    public void btnLoadMoregrid_stickerEid(View view) {
        images = new ArrayList<>();
        names = new ArrayList<>();
        likes = new ArrayList<>();
        downloads = new ArrayList<String>();
