...
public class Action_Activity extends Activity{
    ...
    String URL="http://wap.shabox.mobi/GCMPanel/ClubzAPI.aspx?cat=Action";;
    ...
    public int feed=0;
    private int preLast;
    public static Context actionContext;
    GameItemListActivity gameItemListActivity=new GameItemListActivity();
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new GameListCustomAdapter(pictureList,Action_Activity.this);
            ...
            public void onScroll(AbsListView view, int firstVisibleItem,
                ...
                if (lastItem == totalItemCount) {
                    if (preLast != lastItem) { //to avoid multiple calls for last item
                        ...
                        pDialog = new ProgressDialog(Action_Activity.this);
