...
public class StickerBanglaGridActivity extends ActionBarActivity {
    private PullToRefreshGridView mPullRefreshGridView;
    Subscriptio_Class subscriptio_class;
    Toolbar toolbar;
    Button btnBack;
    //Web api url
    public static final String DATA_URL = Config.URL_STICKER_BANGLA;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sticker_bangla_grid);

        toolbar = (Toolbar) findViewById(R.id.tool_bar_grid_stickerBD);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("");
        btnBack = (Button) toolbar.findViewById(R.id.btn_back);

        mPullRefreshGridView = (PullToRefreshGridView) findViewById(R.id.gridViewgrid_stickerBD);
        ...
        mPullRefreshGridView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener<GridView>() {
            ...
            public void onRefresh(PullToRefreshBase<GridView> refreshView) {
                ...
                stickerBanglaClassList = new ArrayList<StickerBanglaClass>();
                n+=10;
                getData(n);
            }
...
//            }
        ...
        Subscriptio_Class.applicationContext=StickerBanglaGridActivity.this;
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                StickerBanglaGridActivity.this.finish();
    ...
    private void getData(final int num){
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        try {
                            ...
                            for (int i = 0; i<=9+num; i++){
                                ...
                                images.add(stickerBanglaClass.getImageUrl());
                                names.add(stickerBanglaClass.getContent_title());


                            }
                            //Creating GridViewAdapter Object
                            GameGridAdapter gameGridAdapter = new GameGridAdapter(StickerBanglaGridActivity.this,images,names,likes,downloads);
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(StickerBanglaGridActivity.this);
...
//        gameGridAdapter.notifyDataSetChanged();
//    }
    public void btnLoadMoregrid_stickerBD(View view) {
        images = new ArrayList<>();
        names = new ArrayList<>();
        likes = new ArrayList<>();
        downloads = new ArrayList<String>();
