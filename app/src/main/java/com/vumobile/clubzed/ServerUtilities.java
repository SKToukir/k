...
public final class ServerUtilities {
     ...
     *
     */
    public static void register(final Context context,String name, String model ,String email, final String regId) {
        ...
        Log.d("GCMReg","Reg  :"+ regId);
        Log.d("GCMReg","name  :"+name);
        Log.d("GCMReg","model  :"+model);
        Log.d("GCMReg","email  :"+email);
    ...
    private static void post(String endpoint, Map<String, String> params)
      ...
      //For Access log posting
      public void httpServerPost(String url,
    		  String SOURCE_URL,
    		  String MSISDN,
    		  ...
    		  String OS)
      {
  		...
  		try {
  		    ...
  		    HttpPost httppost = new HttpPost("http://203.76.126.210/clubz_android/user_access_log.php");
  			// Add your data
  	        ...
  	        nameValuePairs.add(new BasicNameValuePair("UAPROFILE_URL", UAPROFILE_URL));
  	        ...
  	        nameValuePairs.add(new BasicNameValuePair("PORTAL_N_SHORT", "" + PORTAL_N_SHORT));
  	        ...
  	        if(total.toString().trim().equals("1")){
  	        	Log.i("Access log ","" + total.toString().trim());
  	        }
