...
public class StickerFunnyAdapter extends RecyclerView.Adapter<StickerFunnyAdapter.MyViewHolder> {

    ImageLoader imageLoader;
    private Context mContext;
    private List<StickerFunnyClass> stickerFunnyClassList;

    public StickerFunnyAdapter(Context context, List<StickerFunnyClass> List){
        this.mContext = context;
        this.stickerFunnyClassList = List;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        StickerFunnyClass primaryClass = stickerFunnyClassList.get(position);
    ...
    public int getItemCount() {
        return stickerFunnyClassList.size();
    }
