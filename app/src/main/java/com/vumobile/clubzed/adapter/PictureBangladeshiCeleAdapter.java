...
public class PictureBangladeshiCeleAdapter extends RecyclerView.Adapter<PictureBangladeshiCeleAdapter.MyViewHolder> {

    ImageLoader imageLoader;
    private Context mContext;
    private List<PictureBangladeshiCele> pictureBangladeshiCeleList;

    public PictureBangladeshiCeleAdapter(Context context, List<PictureBangladeshiCele> picList){
        this.mContext = context;
        this.pictureBangladeshiCeleList = picList;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        PictureBangladeshiCele primaryClass = pictureBangladeshiCeleList.get(position);
    ...
    public int getItemCount() {
        return pictureBangladeshiCeleList.size();
    }
