...
public class Sticker_Events extends ActionBarActivity {
    ...
    private static String FEED_URL="http://wap.shabox.mobi/GCMPanel/ClubzAPI.aspx?cat=stk&subcat=EVENTS";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Subscriptio_Class.applicationContext=Sticker_Events.this;
    ...
    public class AsyncHttpTask extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (result == 1) {
                ...
                Toast.makeText(Sticker_Events.this, "Failed to fetch data!", Toast.LENGTH_SHORT).show();
            }
