...
public class Video_OfTheWeek  extends Activity {
    ListView actionListView;
    NetworkImageView actionPageHeader;
    public  String URL = "http://wap.shabox.mobi/GCMPanel/ClubzAPI.aspx?cat=video_Cat&subcat=videoofweek";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Subscriptio_Class.applicationContext=Video_OfTheWeek.this;
        subscriptio_class=new Subscriptio_Class();
        Subscriptio_Class.type="video";
        adapter = new VideoListCustomAdapter(pictureList,Video_OfTheWeek.this);
