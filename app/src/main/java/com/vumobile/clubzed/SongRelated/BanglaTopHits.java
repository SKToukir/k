...
public class BanglaTopHits  extends Activity {
    ListView actionListView;
    NetworkImageView actionPageHeader;
    public  String URL = "http://wap.shabox.mobi/GCMPanel/ClubzAPI.aspx?cat=BFT&subcat=Banglatophits";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bangla_top_hits);

        SongListCustomAdapter.songListAdapterContext=BanglaTopHits.this;
        ...
        Subscriptio_Class.applicationContext=BanglaTopHits.this;
        subscriptio_class=new Subscriptio_Class();
        Subscriptio_Class.type="song";
        Download_Class.applicationContext=BanglaTopHits.this;
        download_class=new Download_Class();



        adapter = new SongListCustomAdapter(pictureList,BanglaTopHits.this);
            ...
            public void onScroll(AbsListView view, int firstVisibleItem,
                ...
                if (lastItem == totalItemCount) {
                    if (preLast != lastItem) { //to avoid multiple calls for last item
                        ...
                        pDialog = new ProgressDialog(BanglaTopHits.this);
                        ...
                        if (howmanyContentTofetch<result.length() && result.length()>10) {
                            for (int i = increment*10; i < howmanyContentTofetch; i++) {    //result.length()
                                try {
                                    ...
                                    Log.i("Content Image Song<<<",obj.getString("ContentTile"));
