...
public class Pic_Love extends ActionBarActivity {
    ...
    private static String FEED_URL="http://wap.shabox.mobi/GCMPanel/ClubzAPI.aspx?cat=love";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Subscriptio_Class.applicationContext=Pic_Love.this;
    ...
    public class AsyncHttpTask extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (result == 1) {
                ...
                Toast.makeText(Pic_Love.this, "Failed to fetch data!", Toast.LENGTH_SHORT).show();
            }
