...
public class FunnyGridActivity extends ActionBarActivity {
    private PullToRefreshGridView mPullRefreshGridView;
    Subscriptio_Class subscriptio_class;
    Toolbar toolbar;
    Button btnBack;
    //Web api url
    public static final String DATA_URL = Config.URL_STICKER_FUNNY;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_funny_grid);

        toolbar = (Toolbar) findViewById(R.id.tool_bar_grid_stickerFunny);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("");
        btnBack = (Button) toolbar.findViewById(R.id.btn_back);

        mPullRefreshGridView = (PullToRefreshGridView) findViewById(R.id.gridViewgrid_stickerFunny);
        ...
        mPullRefreshGridView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener<GridView>() {
            ...
            public void onRefresh(PullToRefreshBase<GridView> refreshView) {
                ...
                stickerFunnyClassList = new ArrayList<StickerFunnyClass>();
                n+=10;
                getData(n);
            }
...
//            }
        ...
        Subscriptio_Class.applicationContext=FunnyGridActivity.this;
    ...
    private void getData(final int num){
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        try {
                            ...
                            for (int i = 0; i<=9+num; i++){
                                ...
                                images.add(stickerFunnyClass.getImageUrl());
                                names.add(stickerFunnyClass.getContent_title());
                                likes.add(obj.getString(Config.TOTAL_LIKE));
                                downloads.add(obj.getString(Config.TOTAL_DOWNLOADS));

                            }
                            //Creating GridViewAdapter Object
                            GameGridAdapter gameGridAdapter = new GameGridAdapter(FunnyGridActivity.this,images,names,likes,downloads);
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(FunnyGridActivity.this);
...
//        gameGridAdapter.notifyDataSetChanged();
//    }
    public void btnLoadMoregrid_stickerFunny(View view) {
        images = new ArrayList<>();
        names = new ArrayList<>();
        likes = new ArrayList<>();
        downloads = new ArrayList<String>();
