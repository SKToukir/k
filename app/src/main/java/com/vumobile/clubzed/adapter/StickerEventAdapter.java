...
public class StickerEventAdapter extends RecyclerView.Adapter<StickerEventAdapter.MyViewHolder> {

    ImageLoader imageLoader;
    private Context mContext;
    private List<StickerEventClass> stickerEventClassList;

    public StickerEventAdapter(Context context, List<StickerEventClass> List){
        this.mContext = context;
        this.stickerEventClassList = List;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        StickerEventClass primaryClass = stickerEventClassList.get(position);
    ...
    public int getItemCount() {
        return stickerEventClassList.size();
    }
